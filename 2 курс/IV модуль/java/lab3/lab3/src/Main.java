...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        triangles.add(createTriangle(1150, 700));
        triangles.add(createTriangle(1180, 700));
        triangles.add(createTriangle(1165, 675));
        ...
        pic.setBounds(550, 550, 697, 230);
        label.setBounds(550, 550, 697, 230);
